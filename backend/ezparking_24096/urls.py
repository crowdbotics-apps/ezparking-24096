"""ezparking_24096 URL Configuration
...
admin.site.site_header = "ezparking"
admin.site.site_title = "ezparking Admin Portal"
admin.site.index_title = "ezparking Admin"

# swagger
api_info = openapi.Info(
    title="ezparking API",
    default_version="v1",
    description="API documentation for ezparking App",
)
